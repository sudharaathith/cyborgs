...
function About(props) {
  ...
  return (
    <div id='about1'  className=' rounded-xl backdrop-blur-xl  sm:p-3 w-full shadow-blue-600 '>
        ...
        <div  ref={ref1}  className='flex flex-col sm:flex-row sm:mt-28 max-sm:mt-20'>
          <motion.img src={logo3} style={{x, opacity:o1}} className='h-52 -z-10 max-sm:mb-11 sm:mr-20 m-auto' />
          <motion.p style={{opacity:o2, y:y1}} className='p-10 sm:p-20 text-slate-200 m-auto text-center'>SRM Valliammai Engineering college (An Autonomous Institution) was established on September 9, 1999. The college has highly qualified, dynamic and dedicated renowned faculty both from academic and industrial background. Besides, the students bring laurels to the college by securing university ranks.The SRM Valliammai Engineering College is a part of the SRM Group of Educational Institutions, sponsored by the Valliammai Society.<span>Vision "Educate to Excel in Social Transformation"</span><span>Mission To contribute to the development of human resources in the form of professional engineers and managers of international excellence and competence with high motivation and dynamism</span></motion.p>
        </div>
