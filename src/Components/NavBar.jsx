...
function NavBar() {
  ...
  return (
    <div className=" backdrop-blur-xl z-40 hidden fixed top-0 w-screen bg-orange-500/5 text-violet-300  px-5 py-2 sm:flex flex-row justify-between items-center  overflow-x-hidden">
