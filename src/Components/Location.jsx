...
const Location = () => {
  ...
  return (
    <motion.div className=' py-9 my-5 sm:px-9 mx-auto rounded-lg bg-slate-900/60' ref={ref} style={{opacity, scale, y}}>
    ...
    <div className='location mx-auto'>
      ...
      <p className=' text-white text-center font-[stylish-regular]'>National Highway 45,<br/> Potheri, <br/>SRM Nagar, <br/>Kattankulathur, <br/>Tamil Nadu 603203</p>
    </div>
    </div>
    </motion.div>   
  );       
