...
const events = [
  ...
  },
  {
    ...
    description: "The Bunker Dilemma immerses participants in a heart-pounding scenario where a nuclear threat looms. ",
    round1: "Round 1: 20 contestants must vie for just 10 bunker spots by artfully persuading organizers of their unique qualifications, whether they excel in engineering, medicine, leadership, or problem-solving.",
  ...
  },
  {
    id: 3,
    title: "Code Mystique",
    description: " CYBORGS 2K23 offers a technical group event with two exciting rounds",
  ...
  },
  {
    ...
    description: "Each match has a 5 to 7-minute time limit, ensuring quick and intense gameplay. While laptops and controllers are provided, participants are welcome to bring their own equipment.",
  ...
  },
  {
    id: 5,
    title: "Cineaste",
    description: "'Cineaste' is a non-technical event at CYBORGS 2K23 that immerses participants in the captivating world of Kollywood through the thrilling Kollywood Quiz.",
